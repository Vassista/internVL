      ...
      <section className="relative min-h-[420px] md:h-[520px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center text-white max-w-3xl mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link to="/upload">
              <Button className="px-6 py-6 text-lg bg-blue-500 hover:bg-blue-600">
                Start Grading Now
                <ChevronRight className="ml-2 h-5 w-5" />
              </Button>
            </Link>
            <Link to="#features">
              <Button variant="secondary" className="px-6 py-6 text-lg">
                Learn More
              </Button>
            </Link>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg transition-transform hover:scale-105">
              ...
              <p className="text-gray-600">Upload a model answer sheet and student answer sheets.</p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg transition-transform hover:scale-105">
              ...
              <p className="text-gray-600">Our home grown, state of the art model evaluates the answer sheets.</p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg transition-transform hover:scale-105">
              ...
              <p className="text-gray-600">View detailed results, and various stats from your dashboard.</p>
            </div>
          </div>
